...
namespace SAutoCarry.Champions.Helpers
{
    public static class SoldierMgr
    {
        ...
        {
            float dmg = (float)ObjectManager.Player.CalcDamage(target, LeagueSharp.Common.Damage.DamageType.Magical, new[] { 50, 55, 60, 65, 70, 75, 80, 85, 90, 100, 110, 120, 130, 140, 150, 160, 170, 180 }[ObjectManager.Player.Level - 1] + 0.6f * ObjectManager.Player.AbilityPower());
