...
namespace SAutoCarry.Champions
{
    public class DrMundo : Champion
    {
        ...
        public override void SetSpells()
        {
            ...
            Spells[Q].SetSkillshot(0.25f, 60f, 1850f, true, SkillshotType.SkillshotLine);
        ...
        public void KillSteal()
        {
            ...
            foreach (Obj_AI_Hero target in HeroManager.Enemies.Where(x => x.IsValidTarget(Spells[Q].Range) && !x.HasBuffOfType(BuffType.Invulnerability)))
            {
